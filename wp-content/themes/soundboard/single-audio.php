                  	...
                  	<div class="album-artwork">                                                
                        ...
                        <div class="album-info">
                                ...
                                <div class="album-buybuttons">
                                  	...
                                  	<ul id="artist-social"><?php $facebook=get_post_meta($post->ID, 'facebook', true);?>
  <?php if ( $facebook ) : ?><li class="soci"><a href="<?php echo $facebook; ?>"><i class="icon-facebook"></i></a></li>
                                            
    <?php endif; ?>
                                            <?php $twitter=get_post_meta($post->ID, 'twitter', true);?>
  <?php if ( $twitter ) : ?>
                                            <li class="soci"><a href="<?php echo $twitter; ?>"><i class="icon-twitter"></i></a></li>
    <?php endif; ?>
                                   
                                            <?php $soundcloud=get_post_meta($post->ID, 'soundcloud', true);?>
  <?php if ( $soundcloud ) : ?>         <li class="soci"><a href="<?php echo $soundcloud; ?>"><i class="icon-soundcloud"></i></a></li>
                                            
    <?php endif; ?>
                               
                                            <?php $youtube=get_post_meta($post->ID, 'youtube', true);?>
  <?php if ( $youtube ) : ?>             <li class="soci"><a href="<?php  echo $youtube; ?>"><i class="icon-youtube"></i></a></li>
    ...
    <?php endif; ?></ul>
                                        ...
                                        if ($buy_other){ ?>
                                                <a style="display:none;" href="<?php echo $buy_other; ?>" class="button2 buy-other"><?php echo $buy_other_text; ?></a>         
                                        <?php }                                          
                                        ?> 
